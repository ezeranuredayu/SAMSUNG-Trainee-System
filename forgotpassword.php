...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $check_email = "SELECT * FROM staff WHERE staff_email = '$email'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $update = "UPDATE staff SET reset_token='$token' WHERE staff_email='$email'";
        if (mysqli_query($conn, $update)) {
            ...
            try {
                ...
                $reset_link = "http://localhost/SAMSUNG/resetpassword.php?token=" . $token;
...
<br><br><br><br><br> 
    <div class="container">
        ...
        <form method="POST">
			<label for="new_password">Enter Your Email:</label>
            <input type="email" name="email" required>
            <button type="submit" value="Send Reset Link">Send Reset Link</button>
        </form>
